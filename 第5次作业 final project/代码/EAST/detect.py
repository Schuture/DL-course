...
def detect_dataset(model, device, test_img_path, submit_path):
	...
	for i, img_file in enumerate(img_files):
		try:
			...
			boxes = detect(Image.open(img_file).convert('RGB'), model, device) # 要转换为RGB
			seq = []
...
if __name__ == '__main__':
	...
	img_path    = os.path.join("/root/CYX_Space/EAST-master/visualization/img", img_name)
	model_path  = "/root/CYX_Space/EAST-master/pths/model_epoch_590.pth"
	res_img     = os.path.join("/root/CYX_Space/EAST-master/visualization/output_img", detected_img_name)
